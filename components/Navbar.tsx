...
export default function Navbar({ onMenuClick }: { onMenuClick: () => void }) {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-gray-950/90 backdrop-blur-md z-40 transition-transform duration-400 ease-out ${
    ...
    >
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 active:scale-95"
          ...
          <button
            onClick={onMenuClick}
            className="text-sm font-medium px-4 py-2 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
          >
            Menu
          </button>
        </div>
